...
class _WhoPageState extends State<WhoPage> {
  ...
  //             TableRow(children: [
  //               Text('experience'),
  //               Text(who.experience.toString())
  //             ]),
  //             TableRow(children: [Text('hostname'), Text(who.hostname)]),
  //             TableRow(children: [
  //               Text('last active'),
  //               Text(who.lastActive.toString())
  //             ]),
  //             TableRow(children: [
  //               Text('last login'),
  //               Text(who.lastLogin.toString())
  //             ]),
  ...
  //   final who = _source.getCellValue(details.rowColumnIndex.rowIndex - 1, '')
  //       as WhoInfo;
  //   _tapWho(context, who);
  // }
...
//   static List<WhoInfo> _filtered(
//       NotifierList<WhoInfo> whoInfos, String filter) {
...
//   @override
//   int compare(WhoInfo a, WhoInfo b, SortColumnDetails sortColumn) =>
//       sortColumn.name == 'user'
