...
''');
    ...
    final board = fb.boardFromLines(lines);
    final move = GammonMove(player: Player.one, fromPipNo: 13, toPipNo: 5, hops: [-6, -2]);
    final deltas = GammonRules.legalMove(move, board);
    expect(deltas, isNotEmpty);
...
''');
    ...
    final board = fb.boardFromLines(lines);
    final move = GammonMove(player: Player.one, fromPipNo: 13, toPipNo: 4, hops: [-2, -2, -2]);
    final deltas = GammonRules.legalMove(move, board);
    expect(deltas, isNotEmpty);
...
''');
    ...
    final board = fb.boardFromLines(lines);
    final move = GammonMove(player: Player.one, fromPipNo: 13, toPipNo: 4, hops: [-2, -2, -2, -2]);
    final deltas = GammonRules.legalMove(move, board);
    expect(deltas, isNotEmpty);
...
''');
    ...
    final board = fb.boardFromLines(lines);
    final move = GammonMove(player: Player.one, fromPipNo: 6, toPipNo: 1, hops: [-1, -4]);
    final result = GammonRules.legalMove(move, board);
    expect(result, isEmpty);
  });
...
''');
    ...
    final board = fb.boardFromLines(lines);
    final move = GammonMove(player: Player.one, fromPipNo: 6, toPipNo: 1, hops: [-6, -6, -6]);
    final result = GammonRules.legalMove(move, board);
    expect(result, isEmpty);
  });
...
''');
    ...
    final board = fb.boardFromLines(lines);
    final move = GammonMove(player: Player.one, fromPipNo: 6, toPipNo: 1, hops: [-4,-4,-4,-4]);
    final result = GammonRules.legalMove(move, board);
    expect(result, isEmpty);
  });
}
